package spio2023.cms.model.sample;

import spio2023.cms.model.device.TestDevice;
import spio2023.cms.model.device.TestScope;
import spio2023.cms.model.instrument.AccuracyPattern;
import spio2023.cms.model.instrument.ReferenceInstrument;
import spio2023.cms.model.instrument.ReferenceScope;
import spio2023.cms.model.procedure.Procedure;
import spio2023.cms.model.procedure.Settings;
...
public class SampleData_PP_METEX_3610 {
    ...
    public static Procedure procedure() {
        ...
        var controlPoints = Map.of(
                dcv, List.of(
                        new ControlPoint(Prefix.MILLI, 180),
                        new ControlPoint(Prefix.MILLI, -180),
                        new ControlPoint(Prefix.MILLI, 20),
                ...
                acv, List.of(
                        new ControlPoint(new Parameter(Prefix.MILLI, 180), new Parameter(60)),
                        new ControlPoint(new Parameter(Prefix.MILLI, 180), new Parameter(400)),
                ...
                dca, List.of(
                        new ControlPoint(Prefix.MICRO, 180),
                        new ControlPoint(Prefix.MILLI, 1.8),
                        new ControlPoint(Prefix.MILLI, 18),
                        new ControlPoint(Prefix.MILLI, 180),
                        new ControlPoint(1.8),
                        new ControlPoint(1),
                        new ControlPoint(18),
                ...
                aca, List.of(
                        new ControlPoint(new Parameter(Prefix.MICRO, 180), new Parameter(60)),
                        new ControlPoint(new Parameter(Prefix.MICRO, 180), new Parameter(400)),
                        new ControlPoint(new Parameter(Prefix.MILLI, 1.8), new Parameter(60)),
                        new ControlPoint(new Parameter(Prefix.MILLI, 1.8), new Parameter(400)),
                        new ControlPoint(new Parameter(Prefix.MILLI, 18), new Parameter(60)),
                        new ControlPoint(new Parameter(Prefix.MILLI, 18), new Parameter(400)),
                        new ControlPoint(new Parameter(Prefix.MILLI, 180), new Parameter(60)),
                        new ControlPoint(new Parameter(Prefix.MILLI, 180), new Parameter(400)),
                        new ControlPoint(1.8, 60),
                        new ControlPoint(1.8, 400),
                ...
                res, List.of(
                        ...
                        new ControlPoint(Prefix.KILO, 19),
                        new ControlPoint(Prefix.KILO, 190),
                        new ControlPoint(Prefix.MEGA, 1.9),
                        new ControlPoint(Prefix.MEGA, 19)
                )
        );
